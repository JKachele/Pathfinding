...
public class DFS {
    ...
    public static  void initialize(Environment panel, JFrame frame) {
        DFS.environment = panel;
        DFS.frame = frame;
        DFS.cells = panel.getCells();
        DFS.startCell = panel.getStartCell();
        DFS.targetCell = panel.getTargetCell();
    }
    ...
    public static void startAlg() {
        ...
        Main.setTempTitle("Started A* Algorithm", 200);
    ...
    private static void getVariables() {
        DFS.cells = environment.getCells();
        DFS.startCell = environment.getStartCell();
        DFS.targetCell = environment.getTargetCell();
    }
